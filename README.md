...
* Due to a complete lack of interest from the community to support further development, several projects have been archived and will no longer be maintained.
There will be no more releases of these libraries.
...
[Unity.AspNet.WebApi](https://github.com/unitycontainer/aspnet-webapi) | [Archived](https://github.com/unitycontainer/aspnet-webapi) | [![NuGet](https://img.shields.io/nuget/v/Unity.AspNet.WebApi.svg)](https://www.nuget.org/packages/Unity.AspNet.WebApi) | [![NuGet](https://img.shields.io/nuget/dt/Unity.AspNet.WebApi.svg)](https://www.nuget.org/packages/Unity.AspNet.WebApi)
[Unity.Mvc](https://github.com/unitycontainer/aspnet-mvc) | [Archived](https://github.com/unitycontainer/aspnet-mvc) | [![NuGet](https://img.shields.io/nuget/v/Unity.Mvc.svg)](https://www.nuget.org/packages/Unity.Mvc) | [![NuGet](https://img.shields.io/nuget/dt/Unity.Mvc.svg)](https://www.nuget.org/packages/Unity.Mvc)

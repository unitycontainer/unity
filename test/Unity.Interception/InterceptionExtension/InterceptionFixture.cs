...
//            var proxy = Intercept.ThroughProxy<IInterfaceA>(target, new TransparentProxyInterceptor(), behaviourArray);
//            proxy.TargetMethod();
...
//            var proxy = Intercept.ThroughProxy<ImplementsMBRO>(target, new TransparentProxyInterceptor(), behaviourArray);
//            proxy.TargetMethod();
...
//            var proxy = (IAdditionalInterface)Intercept.ThroughProxyWithAdditionalInterfaces<ITestInterface1>(target, new TransparentProxyInterceptor(), behaviourArray, new Type[] { typeof(IAdditionalInterface) });
...
//        {
//            var proxy = Intercept.NewInstance<MBROTarget>(new VirtualMethodInterceptor(), new IInterceptionBehavior[] { new TestBehaviour("behaviour1", false), new TestBehaviour("behaviour2", false), new TestBehaviour("behaviour3", true) });

//            string result = String.Empty;

//            proxy.TargetMethod(ref result);

//            Assert.AreEqual<string>("behaviour3preinside targetbehaviour3post", result);
//        }
...
//            MBROTarget proxy = Intercept.ThroughProxy<MBROTarget>(objectToIntercept, new TransparentProxyInterceptor(), new IInterceptionBehavior[] { new TestBehaviour("behaviour1", false), new TestBehaviour("behaviour2", true), new TestBehaviour("behaviour3", false) });

//            string result = String.Empty;

//            proxy.TargetMethod(ref result);

//            Assert.AreEqual<string>("behaviour2preinside targetbehaviour2post", result);
//        }
...
//            ITarget proxy = Intercept.ThroughProxy<ITarget>(objectToIntercept, new InterfaceInterceptor(), new IInterceptionBehavior[] { new TestBehaviour("behaviour1", false) });
...
//        {
//            var proxy = Intercept.NewInstance<MBROTarget>(new VirtualMethodInterceptor(), new IInterceptionBehavior[] { new TestBehaviour("behaviour1", false) });
